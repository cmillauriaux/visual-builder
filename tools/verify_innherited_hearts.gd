## Vérifie que l'histoire "InnheritedHearts" se charge et passe le vérificateur.
## Usage: godot --headless --path . -s tools/verify_innherited_hearts.gd
...
func _init():
	var story_path = "/Users/cedric/Stories/InnheritedHearts"
