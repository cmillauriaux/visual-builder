## Vérifie que l'histoire "L'Épreuve du Héros" se charge et passe le vérificateur.
## Usage: godot --headless --path . -s tools/verify_epreuve_du_heros.gd
...
func _init():
	var story_path = ProjectSettings.globalize_path("res://stories/epreuve-du-heros")
