...
const SequenceVisualEditorScript = null # Découplé pour l'export
const UI_OVERLAY_Z = 5 # Valeur de SequenceVisualEditor.UI_OVERLAY_Z
...
func _ready() -> void:
	...
	_pause_options_center.z_index = UI_OVERLAY_Z
