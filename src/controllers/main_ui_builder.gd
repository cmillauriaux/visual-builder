...
static func _build_top_bar(main: Control) -> void:
	...
	histoire_popup.add_separator()
	histoire_popup.add_item(TranslationServer.translate("Générer les clés de traduction"), 6)
	histoire_popup.add_item(TranslationServer.translate("Vérifier les traductions"), 7)
	histoire_popup.add_separator()
