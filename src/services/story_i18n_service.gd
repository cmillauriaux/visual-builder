...
const UI_STRINGS: Array[String] = [
	...
	"Lecture arrêtée",
	"Fin de la lecture",
	"Fin de la lecture — Game Over",
	"Fin de la lecture — À suivre...",
	"Fin de la lecture (aucune terminaison configurée)",
	"Fin de la lecture — Erreur (cible introuvable ou contenu vide)",
	# Menu principal
	"Nouvelle partie",
	"Charger partie",
	"Options",
	...
	"Non",
	# Sauvegarde rapide
	"Sauvegarde rapide effectuée",
	"Aucune sauvegarde rapide",
	"Impossible de charger la story sauvegardée.",
	# Menu sauvegardes
	"Sauvegardes",
	"Automatiques",
	"Rapides",
	...
	"Compris",
	"Pour une meilleure expérience (plein écran, mode hors ligne), installez l'application :\n\n1. Appuyez sur le bouton de partage (⎙)\n2. Sélectionnez « Sur l'écran d'accueil »",
