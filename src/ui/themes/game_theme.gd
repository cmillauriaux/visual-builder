...
static func _setup_label(theme: Theme) -> void:
	...
	theme.set_font_size("font_size", "Label", UIScale.scale(24))


static func _setup_rich_text_label(theme: Theme) -> void:
	theme.set_color("default_color", "RichTextLabel", COLOR_TEXT_DARK)
	theme.set_font_size("normal_font_size", "RichTextLabel", UIScale.scale(24))
...
static func _setup_check_button(theme: Theme, story_ui_path: String = "") -> void:
	...
	theme.set_font_size("font_size", "CheckButton", UIScale.scale(24))
...
static func apply_tab_container_style(tab: TabContainer) -> void:
	...
	# --- Taille de police ---
	tab.add_theme_font_size_override("font_size", UIScale.scale(24))
